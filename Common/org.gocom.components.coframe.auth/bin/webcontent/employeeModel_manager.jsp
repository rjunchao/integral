...
<body>
    ...
    <div class="nui-fit">
        <div id="grid1" class="nui-datagrid" style="width:100%;height:100%;" 
            ...
            borderStyle="border-left:0;border-right:0;" onrowdblclick="onRowDblClick" dataField="emps" showPager="false">
            <div property="columns">
                <div type="indexcolumn" ></div>
                <div field="empcode" width="120" headerAlign="center" allowSort="true">员工编码</div>
                <div field="empname" width="100%" headerAlign="center" allowSort="true">员工姓名</div>
