...
create table cap_rule (RULE_ID varchar(64) not null, RULE_NAME varchar(64) , TENANT_ID varchar(64) , RULE_TYPE varchar(64) , NAMESPACE varchar(512), RULE_EXPRESSION blob(65535), CREATEUSER varchar(64), CREATETIME timestamp, primary key (RULE_ID));
...
create table org_employee (EMPID numeric(10,0) not null, EMPCODE varchar(30), OPERATORID numeric(18,0), USERID varchar(30), EMPNAME varchar(50), REALNAME varchar(50), GENDER varchar(255), BIRTHDATE date, POSITION numeric(10,0), EMPSTATUS varchar(255), CARDTYPE varchar(255), CARDNO varchar(20), INDATE date, OUTDATE date, OTEL varchar(12), OADDRESS varchar(255), OZIPCODE varchar(10), OEMAIL varchar(128), FAXNO varchar(14), MOBILENO varchar(14), QQ varchar(16), HTEL varchar(12), HADDRESS varchar(128), HZIPCODE varchar(10), PEMAIL varchar(128), PARTY varchar(255), DEGREE varchar(255), MAJOR numeric(10,0), SPECIALTY varchar(1024), WORKEXP varchar(512), REGDATE date, CREATETIME timestamp not null, LASTMODYTIME timestamp not null, ORGIDLIST varchar(128), ORGID numeric(10,0), REMARK varchar(512), TENANT_ID varchar(64) not null, APP_ID varchar(64), WEIBO varchar(255), primary key (EMPID));
...
create table org_position (POSITIONID numeric(10,0) not null, POSICODE varchar(20), POSINAME varchar(128) not null, POSILEVEL numeric(2,0), POSITIONSEQ varchar(512) not null, POSITYPE varchar(255), CREATETIME timestamp not null, LASTUPDATE timestamp not null, UPDATOR numeric(10,0), STARTDATE date, ENDDATE date, STATUS varchar(255), ISLEAF varchar(1), SUBCOUNT numeric(10,0), TENANT_ID varchar(64) not null, APP_ID varchar(64), DUTYID numeric(10,0), ORGID numeric(10,0), MANAPOSI numeric(10,0), primary key (POSITIONID));
