 ...
 * <ul>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getRoleId <em>RoleId</em>}</li>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getPartyType <em>PartyType</em>}</li>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getOrgid <em>Orgid</em>}</li>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getEmpid <em>Empid</em>}</li>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getEmpcode <em>Empcode</em>}</li>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getEmpname <em>Empname</em>}</li>
 *   <li>{@link org.gocom.components.coframe.auth.queryentity.impl.QueryEmpByOrgRoleImpl#getTenantId <em>TenantId</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements QueryEmpByOrgRole;
 */

public class QueryEmpByOrgRoleImpl extends ExtendedDataObjectImpl implements QueryEmpByOrgRole {
	/**
	...
	public final static int INDEX_EMPNAME = 5;
	public final static int INDEX_TENANTID = 6;
	 ...
	 * <!-- end-user-doc -->
	 */
	public QueryEmpByOrgRoleImpl(Type type) {
		super(type);
	}
