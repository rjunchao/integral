 ...
 */
public class EmpAuthPartyService extends DefaultAuthPartyService {

	public EmpAuthPartyService() {
		super(IConstants.EMP_PARTY_TYPE_ID);
	}
	/**
	 * 查询父机构和父岗位
	 */
	public String[] getParentPartyTypes() {
		return new String[] { IConstants.ORG_PARTY_TYPE_ID,
