...
<%@page import="org.gocom.components.coframe.init.UserObjectInit"%>
...
<div id="wrapper" class="wrap">
	<div id="header">
		<div class="head-in clearfix">
			<div class="fl clearfix">
				<img class="head" src="<%=contextPath%>/coframe/tools/skins/skin1/images/vbm_logo.png" width="250" height="50%" alt="" />
			</div>
			<div class="options fr">
				<%-- <lable><% UserObject userObject = (UserObject)session.getAttribute("userObject"); %><%=userObject.getUserName()+":"+userObject.getUserOrgName() %></lable> --%>
		...
		<div id="container">
				<div id="wrapper" class="wrap">
					...
					<div class="sidebar">
						...
						<!--左侧菜单-->
						<div  class="nui-fit">
							<div class="menu-wrap" style="width:100%;height:100%;">
								<ul class="menu" height="100px" style="width:100%;height:100%;">
					...
					<div class="main">
						...
						<div class="positionbar">
							<ul class="position clearfix" id="positionbar">
								<li class="index">
								<%-- <span> <a href="<%=contextPath %>/coframe/auth/skin1/index.jsp">第一页</a></span> --%>
								 <a href="<%=contextPath %>/coframe/auth/skin1/index.jsp"> <span>首页</span> </a>
	...
	<div id="footer">
		<p>Ronhe Information Technology  Co., Ltd.</p>
	</div>
</div>
</div>
</body>
...
<script type="text/javascript">
	...
	function initialPositionbar(){
		var currentHtml = $("#positionbar").html();
		var initialData = "<li class='index'><a href=\"<%=contextPath %>/coframe/auth/skin1/index.jsp\"><span>首页</span></a><b class='arrow'></b></li>";
