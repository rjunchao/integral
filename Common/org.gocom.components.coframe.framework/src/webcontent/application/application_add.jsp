...
<body>
		...
		<div id="form1">
	        <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table" >
	            ...
	            <tr>
	                ...
	                <td colspan="3">                        
	                    <input id="appapplication.url" name="appapplication.url" class="nui-textbox nui-form-input" onvalidation="urlvalidation"/>
	                </td>
	            </tr>
	            <tr class="odd">
	                <th class="nui-form-label"><label for="appapplication.appdesc$text">应用描述：</label></th>
	                <td colspan="3">    
	                    <input id="appapplication.appdesc" name="appapplication.appdesc" class="nui-textarea nui-form-input" style="height:100px;" vtype="rangeLength:1,255"/>
	                </td>
	            </tr>
	        </table>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "org.gocom.components.coframe.framework.ApplicationManager.saveApplication.biz.ext",
                type: 'POST',
                data: json,
                cache: false,
