...
<div style="padding-top:5px">
	<div id="form1">
		<input id="appfuncgroup.appApplication.appid" name="appfuncgroup.appApplication.appid" class="nui-hidden" />
        <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table" >
            <tr>
                <th class="nui-form-label"><label for="appfuncgroup.funcgroupname$text">功能组名称：</label></th>
                <td>    
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "org.gocom.components.coframe.framework.FuncGroupManager.saveFuncGroup.biz.ext",
                type: 'POST',
                data: json,
                cache: false,
        ...
        function SetData(data) {
            ...
            data = nui.clone(data);
            document.getElementById("appfuncgroup.appApplication.appid").value = data.appid;
        }
    </script>
</body>
</html>