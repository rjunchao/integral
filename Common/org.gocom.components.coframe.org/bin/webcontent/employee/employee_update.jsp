		        ...
		        <div class="fieldset-body">
		            <table style="width:100%;table-layout:fixed;" class="nui-form-table" >
						...
						<tr class="odd">
							...
							<td>
							<input id="user.authmode" class="nui-combobox" name="user.authmode" value="local"
          						data="authMode" />
          						<!-- 
<input id="authmode" name="user.authmode" data="data" emptyText="请选择" valueField="dictID" textField="dictName" class="nui-dictcombobox" dictTypeId="COF_AUTHMODE" value="local"/>
						...
						<tr class="odd">
							...
							<td colspan="3"><input id="menutype" name="user.menutype" data="menuType" emptyText="请选择"  class="nui-combobox"  value="0"/></td>
						</tr>
					</table>
		        </div>
			</fieldset>
		...
		<div id="form2">
			<table style="width:100%;table-layout:fixed;" class="nui-form-table" >
				<tr>
					...
					<td><input id="oemail" name="employee.oemail" class="nui-textbox" vtype="email" vtype="email;rangeLength:0,128"/></td>
				</tr>				
				<tr class="odd">
