 ...
 */
public class PosPosRefDataService implements IPartyTypeRefDataService {

private DefaultPositionManager bean;
	
	public PosPosRefDataService() {
	...
	public List<Party> getChildrenPartyList(String parentPartyID, String tenantID) {
		// 根据岗位获取岗位下的子岗位表
		OrgPosition[] positions = bean.getSubPositions(parentPartyID, tenantID);
