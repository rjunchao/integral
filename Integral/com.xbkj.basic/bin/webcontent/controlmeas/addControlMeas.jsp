...
<script type="text/javascript">
    ...
    function saveData(){
		...
		nui.ajax({
			url:"com.vbm.grc.basic.control.meas.controlmeas.addControlMeas.biz.ext",
			cache:false,
			data:json,
			type:"POST",
    ...
    function onCodeValidation(e){
		...
		var json = nui.encode({vo:{meas_code:val}});
		$.ajax({
	...
	function SetData(data){
		...
		//设置层级 
		nui.get("meas_level").setValue(level);
		//设置pid
