...
<!-- 
  - Author(s): heFei
  - Date: 2016-07-15 17:03:54
  - Description:对风险影响程度的修改
-->
<head>
<title>修改风险影响程度</title>
</head>
<body>
     ...
     //编码的校验 
      ...
      function SavaData(){
            //校验
      		...
      		nui.ajax({
      		   url: "com.vbm.grc.basic.risk.effectlevel.riskeffectlevel.updateRiskEffectLevel.biz.ext",
      		   cache: false,
      		   data: json,
      		   type: "POST",
      		   contentType: "text/json",
