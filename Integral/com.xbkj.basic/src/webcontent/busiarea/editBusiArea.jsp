	...
	<div id="form1" method="post" class="nui-fit" style="height:90%;">
		...
		<table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table_new">
			<tr>
				...
				<td>
					 <input id="busi_code" name="busi_code"  class="nui-textbox nui-form-input" required="true"  onvalidation="onCodeValidation" vtype="maxLength:32"/>
				</td>
