	...
	<div id="form1" method="post" class="nui-fit" style="height:85%;">
		...
		<table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table_new">
			<tr>
				...
				<td>
					 <input id="meas_code" name="meas_code" class="nui-textbox nui-form-input" onvalidation="onCodeValidation" required="true" vtype="maxLength:20"/>
				</td>
				<td class="nui-form-label">控制措施分类名称：</td>
				<td>
					 <input id="meas_name"  name="meas_name" class="nui-textbox nui-form-input" onvalidation="validateName" required="true" vtype="maxLength:100"/>
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
    ...
    function onCodeValidation(e){
		...
		if(!re.test(val)){
			//输入的特殊字符
			e.isValid = false;
			nui.alert("控制措施分类编码由数字字母组成，请重新填写");
			return;
		}
		//得到主键
