...
<body>
		...
		<div id="form1" method="post">
			<input id="parent_file_id" name="parent_file_id" class="nui-hidden" />
...
<script type="text/javascript">		
	...
	function SetData(data) {
        ...
        data = nui.clone(data);
       	nui.get("belong_to").setValue(data.belongTo);
       	nui.get("parent_file_id").setValue(data.parentCode);
    }
    //保存数据
    function saveData(){
    	//校验
    	...
    	//发送保存请求
    	 nui.ajax({
		    url:"com.vbm.grc.basic.filesystem.filemanage.addFile.biz.ext",
		    type:'POST',
		    data:json,
		    cache:false,
    ...
    function fileupload(){
		...
		if(name == null || name == ""){
			...
			return;
		 	...
		 	//var reguName = name.substring(0,index);
