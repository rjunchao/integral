	...
	<div id="form1" method="post" class="nui-fit" style="height:80%;">
		...
		<table style="width:100%;align:center;" class="nui-form-table_new">
			...
			<tr>
				...
				<td >	
					<input id="risk_level" name="risk_level" class="nui-textbox nui-form-input" 
						onvalidation="validateLevel" required="true" vtype="maxLength:40"/>
				</td>
...
<script type="text/javascript">
    ...
    function saveData(){
		...
		nui.ajax({
		    url:"com.vbm.grc.basic.risk.level.risklevel.addRiskLevel.biz.ext",
		    type:'POST',
		    data:json,
		    cache:false,
