...
<!-- 
  ...
  - Description: 查询礼品审批进度
-->
<head>
	<title>查询礼品审批进度</title>
    ...
    <div class="nui-fit" style="padding:0px 10px 10px 10px;">
	    <div id="grid" class="nui-datagrid" style="width:100%;height:100%;" 
		    ...
		    <div property="columns">
		        ...
		        <div field="apply_product_code" width="150px" headerAlign="center" allowSort="false">申请礼品编号</div>
		        <div field="apply_product_name" width="120px" headerAlign="center" allowSort="false">申请礼品名称</div> 
		        <div field="apply_product_num" width="90px" headerAlign="center" >申请礼品数量</div> 
