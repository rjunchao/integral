...
// set fp img api
var setDisplayedFPImageAtUrl = apiUrl + 'SetDisplayedFPImageAt?nCanvasWidth=140&nCanvasHeight=280&nLeft=20&nTop=65&nWidth=100&nHeight=150';
// clear ink api
        ...
        var timeId = setTimeout(function () {
            ...
            if (isPolling) {
                $.ajax({
                    ...
                    if (result == '2') {
                        alert('Notify From Device : FingerPrint Image captured completed.');
                    } else if (result == '1') {
