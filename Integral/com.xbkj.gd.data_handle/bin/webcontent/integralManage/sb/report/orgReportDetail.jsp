...
<body>
    ...
    <div class="nui-fit" style="padding:0px 10px 10px 10px;">
	    <div id="grid" class="nui-datagrid" style="width:100%;height:100%;" 
		    ...
		    <div property="columns">
		        ...
		        <div field="apply_product_name" width="150px" headerAlign="center" allowSort="false">申请礼品总数</div>
		...
		<form id="excelForm"  action="<%=request.getContextPath() %>/gd/data_handle/integralManage/sb/report/prodReportExp.jsp" 
		     ...
		     <input type="hidden" name="counttype" value="2" />
	    	 ...
	    	 <input type="hidden" name="apply_org" id="apply_org_form" />
		</form>
	...
	<script type="text/javascript">
		...
		function downReport(){
			...
			let apply_org = nui.get("apply_org").getValue();
			...
			document.getElementById("apply_org_form").value=apply_org;
