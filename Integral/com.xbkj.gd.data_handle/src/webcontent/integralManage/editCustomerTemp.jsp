...
<body>
	<div id="form1" method="post" class="nui-fit" style="height:80%; width:100%;">
			...
			<table >
				<tr>           
					...
					<td style="text-align:left;">
						 ...
						 <input id="customer_name" name="customer_name"  class="nui-textbox" enabled="false"
				...
				<tr>
					...
					<td style="text-align:left;">
						<input id="customer_phone" name="customer_phone" enabled="false"
				...
				<tr>
					<td style="text-align:right;">VIP：</td>
					<td style="text-align:left;">
						<input id="def1" name="def1" 
							class="nui-combobox" data = "vipData" style="width:150px;" />
					</td>
				</tr>
				<tr>
	 ...
	 <script type="text/javascript">
	  var vipData = [{id:"Y", text:"Y"}, {id:"N", text:"N"}];
		nui.parse();
