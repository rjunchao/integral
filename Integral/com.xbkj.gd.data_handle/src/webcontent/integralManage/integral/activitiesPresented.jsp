...
<body>
	<div id="form1" method="post" class="nui-fit" style="height:80%; width:100%;"vtype="int">
		...
		<table >
			<br/>
			<tr>           
				<td style="text-align:right;">活动积分：</td>
				<td>
					 <input  id="ap_integral" name="ap_integral" class="nui-textbox" style="width:140px;" vtype="int" required="true"/>
				</td>
			</tr>
			<tr>
	 ...
	 <script type="text/javascript">
		...
		function SaveData(){
			...
			nui.ajax({
				url:"com.xbkj.gd.data_handle.cust.ap.addAp.biz.ext",
				cache:false,
				data:json,
				type:"POST",
