...
<body>
	        ...
	        <table>
	            <tr>
		            ...
		            <td>
		            	...
		            	<a class="nui-button" iconCls="icon-download" onclick="downIntegral()" plain="true">导出积分明细</a>
		            </td>
	            </tr>
	        </table>
	    </div>
	...
	<!-- 导出 -->
		 <form id="excelForm"  action="<%=request.getContextPath() %>/gd/data_handle/integralManage/report/exportOtherIntegralDetail.jsp" 
    ...
    <div class="nui-fit" style="padding:0px 10px 10px 10px;">
	    <div id="grid" class="nui-datagrid" style="width:100%;height:100%;" 
		    url="com.xbkj.gd.data_handle.cust.otherIntegral.pageOtherIntegral.biz.ext"  
		    ...
		    <div property="columns">
		        ...
		        <div field="other_integral" width="100px" headerAlign="center" allowSort="false">操作积分</div>
