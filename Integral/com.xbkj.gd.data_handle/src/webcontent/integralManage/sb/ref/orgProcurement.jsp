...
<body>
	<div id="form1" method="post" class="nui-fit" style="height:80%; width:100%;">
	 ...
	 <div class="nui-toolbar" style="text-align:center;padding:0px;height:20%;" borderStyle="border:0;">
        <a id="savedata" class="nui-button" style="width:60px;" iconCls="icon-save" onclick="onOk()">采购</a>
	 ...
	 <script type="text/javascript">
		...
		function SaveData(){
			...
			let remark = o.remark;
			var json = nui.encode({vos:datas,params:{remark:remark}});
			nui.confirm("确定采购？","确认", function(action){
				if(action == "ok"){
					nui.ajax({
