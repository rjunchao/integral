	...
	<div style="padding:0px 10px 0px 10px;">
		<div class="nui-toolbar" style="padding:2px;border-bottom:0;">
	        <table style="width:100%;">
	            <tr>
		            <td style="width:100%;">
		            	<a class="nui-button" iconCls="icon-upload" onclick="orgAudit()" plain="true">向合行申请</a>
		            	<a class="nui-button" iconCls="icon-cancel" onclick="orgAbort()" plain="true">拒绝</a>
		            	<a class="nui-button" iconCls="icon-redo" onclick="orgAllot()" plain="true">分理处调度</a>
		...
		function statusRenderer(e){
      	...
      	function orgAllot(){
      		/**
      			分理处调度
      		*/
      		//gd/data_handle/integralManage/sb/ref/orgAdminAllot.jsp
      		...
      		nui.open({
				url:"<%=request.getContextPath() %>/gd/data_handle/integralManage/sb/ref/orgAdminAllot.jsp",
				title:"礼品调拨",
				width:360,
				height:260,
				onload:function(){
      	...
      	function orgAudit(){
      		...
      		*/
      		...
      		nui.confirm("确定向合行申请？","申请确认", function(action){
				if(action == "ok"){
					//
					var json = nui.encode({vos:rows});
					nui.ajax({
						url:"com.xbkj.gd.data_handle.prod.giftAudit.subAudit.biz.ext",
						cache:false,
						async:true,
						data:json,
						type:"POST",
