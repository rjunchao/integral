	        ...
	        <table style="width:100%;">
	            <tr>
		            <td style="width:100%;">
		            	...
		            	-->
		            	<a class="nui-button" iconCls="icon-redo" onclick="subIntegral()" plain="true">减少积分</a>
		            	<!-- 
		            	<span class="separator"></span>
	...
	<script type="text/javascript">
		...
		*/
		...
		function edit(){
			...
			if(len > 0 ){
				...
				//编辑
				nui.open({
					url:"<%=request.getContextPath() %>/gd/data_handle/integralManage/editCustomerTemp.jsp",
					title:"修改客户信息",
					width:600,
					height:180,
					onload:function(){
		...
		*/
		function addIntegral(){
			...
			if(row){
				nui.open({
					url:"<%=request.getContextPath() %>/gd/data_handle/integralManage/addCustIntegral.jsp",
					title:"添加客户积分",
					width:600,
					height:220,
					onload:function(){
